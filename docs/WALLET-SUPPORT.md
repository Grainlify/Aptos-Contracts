...
>
> 1. A production endpoint signs as fee payer and submits.
...
it is wrong as a description of what ships now. See the block at step 5 and
Grainlify-Backend#536. It comes back with the second wallet, if that
wallet needs it.
